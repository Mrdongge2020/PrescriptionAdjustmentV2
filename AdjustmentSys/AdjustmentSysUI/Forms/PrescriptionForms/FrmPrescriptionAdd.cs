...
namespace AdjustmentSysUI.Forms.PrescriptionForms
{
    public partial class FrmPrescriptionAdd : UIForm
    {
        ...
        public FrmPrescriptionAdd(string preId, int? preStatus)
        {
            InitializeComponent();
            PreId = preId;
            PreStatus = preStatus;
        ...
        private void InitCopyPreData()
        {
            ...
            foreach (var parinfo in preInfo.Details)
            {
            ...
            dgvFooter["DoseHerb"] = ComputeColumnSum(dgvDurgList, "DoseHerb").ToString();
            dgvFooter["Dose"] = ComputeColumnSum(dgvDurgList, "Dose").ToString();
            dgvFooter["Price"] = ComputeColumnSum(dgvDurgList, "Price").ToString();
            dgvFooter["TotalPrice"] = ComputeColumnSum(dgvDurgList, "TotalPrice").ToString();
        ...
        private bool AddDurgCheck(ParticlesInfoModel particlesInfoModel, bool isCheckRuler = true)
        {
            ...
            {
                var rulercheckList = CheckRuler(particlesInfoModel.ID, parIdList);
        ...
        private List<string> CheckRuler(int parId, List<int> parIds)
        {
            //获取所有规则
            var rulers = _prescriptionBLL.GetAllRuler();
