...
{
    public partial class UC_PreLoadedList : UserControl
    {
        ...
        private void UC_PreLoadedList_Load(object sender, EventArgs e)
        {
            InitDownLoadPre();
        }
        ...
        private void 终止调剂ToolStripMenuItem_Click(object sender, EventArgs e)
        {
