...
namespace AdjustmentSysUI.Forms.MedicineCabinetForms
{
    public partial class FrmAdjustmentOfSurplus : UIForm
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (txtTPQPZL.Text != (OldMachinePublic.Weight - meDetails.EmptyBottleWeight).ToString())
            {
                txtTPQPZL.Text = (OldMachinePublic.Weight - meDetails.EmptyBottleWeight).ToString();
            }
            ...
            //调整量计算
            float tzl = (float)OldMachinePublic.Weight - meDetails.EmptyBottleWeight.Value - meDetails.Stock.Value;
