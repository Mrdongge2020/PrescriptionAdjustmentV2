...
namespace AdjustmentSys.Models.Machine
{
    public class Machine
    {
        ...
        public int Papernuber; //处方签打印数量
        public bool Stop; //暂停
        public bool Startstop;//终止处方
        ...
        public bool Oddsate;//true为奇数调方
        public bool Oddstata1;
        ...
        public bool HCSealex; //缓存启动开始封口
        public int SealTep; //设置的封口温度
        public int SealCH9; //开始封口
        public long SealTime;//超时检查

        public bool Sealfinsh;//封口全部完成
        public bool Sealfinshd;//封口一阶段完成
        public bool ResetSealfinshd;//复位封口一阶段完成
        ...
        public int HCbox;//缓存药盒序号
        public int HCseal;//缓存封口药盒序号
        public int HCoutbox;//缓存下盒序号
        ...
        public bool[] TAxisHomeExcute = new bool[10];//单轴回零启动
        public bool[] TAxisHomefinish = new bool[10];//单轴回零完成
        ...
        public Int32 iError; //异常 bit1温湿度未连接；2天平；3RFID未连接 4温控仪表未连接
        public Int32 iRestError; //复位异常 =5复位该工位已有药盒错误， =6复位下盒失败错误 =12出盒失败错误 =13出盒超时
        ...
        public class DetailgG  //工位数据结构
        {
            ...
            public int DrugeValue;//完成的下药次数
            public int bDrugeValue;//放入工位后调剂次数
            public bool HCStartDeruge; //启动调剂
            public bool StartDeruge; //启动调剂
            public bool Derugeing;
            public bool Derugefinish;//调剂完成；
            public int Particlesstate; //颗粒状态 =0本处方未包含该药品 =2待调剂状态 =3调剂中  =8颗粒余量不足  =10不是该处方药品  =11已有该药品称重信息    =12该药品未称重   4;//工位待取走状态
